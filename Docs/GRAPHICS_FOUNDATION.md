...
BIOS or non-x86_64 firmware. Firmware loader paths are still same-ESP schema 1
entries generated by the OS-side scanner; native multi-ESP/NVRAM discovery is a
separate installer and discovery milestone.
